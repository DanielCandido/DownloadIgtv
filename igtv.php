...
<body>
	...
	<?php 
	 $file_name = 'teste.mp4';
	 $file_url = 'https://scontent.cdninstagram.com/vp/33066c47cab0c234aee23f6543403264/5CD435D8/t50.16885-16/10000000_401766933744220_8164407537462935552_n.mp4?_nc_ht=scontent.cdninstagram.com';
...
<script type="text/javascript">
	function pegaUrl(){
		...
		for(let i =0; i < html.length; i++){
			attr.push({nome: html[i].content},);
		}


		console.log(attr);
		/*for (var i = 0; i < attr.length; i++) {
			download(attr[i].nome, 'nome','video/mp4');
		}*/
		
		

		setTimeout(this.pegaUrl, 3000)
</script>
